...
MoveEnd:
	...
	move RAZOR_WIND,   HYPER_BEAM_EFFECT,               120, FLYING,    75, 10
	...
	move DROWZEESIS,     SLEEP_EFFECT,                 0, PSYCHIC,   60, 20
	...
	move SKULL_BASH,   RECOIL_EFFECT,              90, ROCK,   100, 15
	...
	move SKY_ATTACK,   HYPER_BEAM_EFFECT,              140, FLYING,    90,  5
	...
	move SPLASH,       CHARGE_EFFECT,                100, WATER,   100, 40
